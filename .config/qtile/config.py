...
#    Key([mod], "r", lazy.spawncmd(), desc="Spawn a command using a prompt widget"),
    ...
    Key([], "XF86AudioRaiseVolume", lazy.spawn("blending vol+"), desc='Volume Up'),
    Key([], "XF86AudioLowerVolume", lazy.spawn("blending vol-"), desc='Volume Down'),
    Key([], "XF86AudioMute", lazy.spawn("blending volx"), desc='Volume Mute'),
    Key([], "XF86AudioPlay", lazy.spawn("playerctl play-pause"), desc='playerctl'),
    Key([], "XF86AudioPrev", lazy.spawn("playerctl previous"), desc='playerctl'),
    Key([], "XF86AudioNext", lazy.spawn("playerctl next"), desc='playerctl'),
    Key([], "XF86MonBrightnessUp", lazy.spawn("blending light+"), desc='Brightness Up'),
    Key([], "XF86MonBrightnessDown", lazy.spawn("blending light-"), desc='Brightness Down'),
