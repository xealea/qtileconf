...
if command -v xbps-install &>/dev/null; then
    ...
    sudo pacman -Sy pulseaudio bluez bluez-alsa-git blueman bluez rofi pamixer networkmanager alacritty git curl neovim xfce4-settings qtile xorg xorg-xinit xorg-font-util xorg-fonts-encodings xorg-fonts-misc xorg-fonts-type1 xorg-server xorg-xev xorg-xkill xorg-xprop xorg-xrandr xorg-xset xorg-xhost xorg-xlsatoms xorg-xlsclients xorg-xmessage xorg-xmodmap xorg-xwd xorg-xwininfo dconf dconf-editor dconf rsync wget aria2 dunst python python-pip python-setuptools feh gtk2 gtk3 gtk4 nano xsettingsd xsetroot gcc gcc-multilib thunar-volman thunar-archive-plugin thunar-media-tags-plugin pipewire pavucontrol starship psutils acpi acpica-tools acpid dhcpcd-gtk imagemagick pfetch htop exa openssh openssl xdg-user-dirs xdg-user-dirs-gtk picom gnupg mpv nwg-launchers nwg-look linux-firmware-intel intel-gmmlib intel-gpu-tools intel-media-driver intel-ucode vulkan-icd-loader android-file-transfer android-tools android-udev-rules libvirt libvirt-glib libvirt-python gvfs gvfs-afc gvfs-afp gvfs-cdda gvfs-goa gvfs-gphoto2 gvfs-mtp gvfs-smb udiskie udisks2 brightnessctl xdotool apparmor libselinux rpmextract lxappearance lxappearance-obconf xfce4-power-manager xfce-polkit polkit-elogind maim viewnior nodejs npm node_exporter xdg-desktop-portal xdg-desktop-portal-kde xdg-desktop-portal-wlr xdg-desktop-portal-gnome xdg-desktop-portal-gtk xdg-user-dirs xdg-user-dirs-gtk xdg-utils gedit zip unzip tar p7zip bzip2 zstd lz4 lz4jsoncat xz libxft libxinerama make virt-manager fish pasystray network-manager-applet
